  ...
  try {
    ...
    await transporter.sendMail({
      ...
      text: `Ciao ${playerName}, so che non stai facendo niente. È il tuo turno. Tira il dado e rispondi!`,
        html: `<p>Quack <strong>${playerName}</strong>,</p><p>smettila di sguazzare nello stagno senza far nulla! È il tuo turno.</p><p>Prendi il dado con le tue ali, lancialo e starnazza la risposta prima di perdere le piume!</p><a href ="https://0rteip.github.io/papera-game/index.html">Quack</a>`
    });
